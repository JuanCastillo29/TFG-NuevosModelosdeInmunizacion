# -*- coding: utf-8 -*-
"""
Created on Mon Jun 10 15:08:26 2024
...
k0=6 #Concectividad promedio deseada
...
R0Min=0.5
R0Max = 4.5
N=int((R0Max-R0Min)/0.2)+1
R0 = np.linspace(R0Min, R0Max, N)

#%%
#En esta sección del código se crea la red Erdo
