# -*- coding: utf-8 -*-
"""
Created on Sun May 26 20:19:45 2024
...
m = 3 # Conectividad media deseada
...
def Explore(graph, I, k, n, R0, N):
    ...
    for t in range(0, N):
        lamb = R0[t]*mu/k
        Infectados[t] = SimuVac(graph, I, int(0.1*n), t, InfectadosVar, n, lamb)
...
graph= nx.barabasi_albert_graph(n0, m)
...
plt.grid(True)
# Añadir un recuadro con texto
texto_recuadro = 'Red Barabasi-Albert\nConectividad media: {:.1f}\nNº de nodos: {}\n$\lambda/\mu$: {:.2f} '.format(k, n, lamb/mu)
