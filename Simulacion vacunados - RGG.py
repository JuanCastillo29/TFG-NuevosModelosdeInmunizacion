...
r=math.sqrt(k/(math.pi*n0)) #Red RGG - Radio en el que se realizan las conexiones
...
Nsim = 50 #Numero de veces que se realiza cada simulación
...
graph= nx.random_geometric_graph(n0, r)
...
#En esta sección del código se explora la evolución con R0 a un V fijo
N=int((7-0.5)/0.2)+1
R0 = np.linspace(0.5, 7, N)
...
texto_recuadro = 'Random Geometric Graph \nNº de nodos: {}\nConectividad media: {:.1f}\n 10% vacunados'.format( n, k)
ax.text(2.25, 0.35, texto_recuadro, ha='center', va='center', fontsize=11, bbox=dict(facecolor='white', edgecolor='black', boxstyle='round,pad=0.5'))
